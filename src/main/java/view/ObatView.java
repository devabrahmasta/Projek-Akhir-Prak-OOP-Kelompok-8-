...
public class ObatView extends JPanel {
    ...
    public ObatView() {
        ...
        JLabel titleLabel = new JLabel("Manajemen Data Obat");
        ...
        JLabel formTitle = new JLabel("Form Data Obat");
        formTitle.setFont(new Font("Poppins", Font.BOLD, 16));
        formTitle.setForeground(COLOR_TEXT);
        formPanel.add(formTitle, gbc);
        
        gbc.gridy++;
        formPanel.add(createFormLabel("ID Obat [Otomatis]:"), gbc);
        gbc.gridy++;
        ...
        gbc.gridy++;
        formPanel.add(createFormLabel("Harga:"), gbc);
        gbc.gridy++;
        ...
        JLabel tableTitle = new JLabel("Daftar Obat");
