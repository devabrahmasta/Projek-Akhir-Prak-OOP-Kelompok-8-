...
public class ResepView extends JPanel {
    ...
    public ResepView() {
        ...
        JLabel titleLabel = new JLabel("Manajemen Data Resep");
        ...
        JLabel formTitle = new JLabel("Form Data Resep");
        formTitle.setFont(new Font("Poppins", Font.BOLD, 16));
        formTitle.setForeground(COLOR_TEXT);
        formPanel.add(formTitle, gbc);
        
        gbc.gridy++;
        formPanel.add(createFormLabel("ID Resep [Otomatis]:"), gbc);
        gbc.gridy++;
        ...
        gbc.gridy++;
        formPanel.add(createFormLabel("ID Dokter:"), gbc);
        gbc.gridy++;
        txtDokterId = new JTextField();
        styleTextField(txtDokterId);
        formPanel.add(txtDokterId, gbc);

        gbc.gridy++;
        formPanel.add(createFormLabel("IDs Obat (comma separated):"), gbc);
        gbc.gridy++;
        txtObatIds = new JTextField();
        styleTextField(txtObatIds);
        formPanel.add(txtObatIds, gbc);

        gbc.gridy++;
        formPanel.add(createFormLabel("Keterangan:"), gbc);
        gbc.gridy++;
        txtKeterangan = new JTextField();
        styleTextField(txtKeterangan);
        ...
        JLabel tableTitle = new JLabel("Daftar Resep");
